...
function Fly(fid, type, color, sh, sw, x, y, fly_img, name, title) {
	...
	if(this.name == 'Hói Ca'){
		...
		this.gender = "BueDue";
	} else if(this.name == 'Bông Cô Nương') {
		$(t).html(this.name + " nói:\n"+'"Hói ca à! Chàng đang ở đâu vậy.."');
		this.gender = "Gei";
	} else if(this.name == 'Ahn Đại Gia') {
		$(t).html(this.name + " nói:\n"+'"Tao đang đi tìm thằng Hói để đòi tiền!"');
		this.gender = "BueDue";
	} else if(this.name == 'Xăng Tiểu Muội') {
		$(t).html(this.name + " nói:\n"+'"Có ai thấy bình xăng của ta đâu không?.."');
		this.gender = "Gei";
	} else if(this.name == 'Heo Xôi Chiên') {
		$(t).html(this.name + " nói:\n"+'"Phụt...há há há"');
		this.gender = "Gei";
	} else {
		$(t).html(this.name + " nói:\n"+'"Sệch xi miu dịch.."');
	...
	// }else{
		...
		setTimeout(function() {
			//if (Math.random() < show_percent/100) {
				...
				switch (value) { 
					case 1: 
						var fly = new Fly("test", "Nhây", "Xanh", height_fly, width_fly, 0, 0, "https://redirect.nhq.vn/demo/js/images/ruoi_11.png", "Bông Cô Nương", "Bến Tre");
						break;
					case 2:
					 	var fly = new Fly("test", "Hói", "Đen", height_fly, width_fly, 0, 0, "https://redirect.nhq.vn/demo/js/images/ly_mac_ruoi.png", "Ahn Hói Ca", "Tân Sơn Nhất");						
					 	break;
					case 3: 
					 	var fly = new Fly("test", "Đại Gia", "Đỏ", height_fly, width_fly, 0, 0, "https://redirect.nhq.vn/demo/js/images/doc_co_ruoi.png", "Ahn Đại Gia", "Cục Súc");		
					 	break;
					case 4: 
						var fly = new Fly("test", "Lửa", "Nâu", height_fly, width_fly, 0, 0, "https://redirect.nhq.vn/demo/js/images/ruoi_9.png", "Xăng Tiểu Muội", "Petrolimex");		
						break;
					case 5: 
						var fly = new Fly("test", "Nhiều Chiện", "Xanh", height_fly, width_fly, 0, 0, "https://redirect.nhq.vn/demo/js/images/ruoi_11.png", "Heo Xôi Chiên", "Phụt há há..");
						break;
			...
			if(var_2){
				if (Math.random() < show_percent_fly2/100) {
					...
					var fly2 = new Fly("test", "BueDue", "Đen", height_fly, width_fly, 0, 0, "https://redirect.nhq.vn/demo/js/images/ly_mac_ruoi.png", "An Hói Ca", "Tân Sơn Nhất");	
					fly2.move();
					fly2.flying();
